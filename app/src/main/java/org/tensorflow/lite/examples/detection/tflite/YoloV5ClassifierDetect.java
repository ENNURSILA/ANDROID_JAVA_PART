...
//
//                Log.d("GOZDENn KACMIS", "mObjThresh: " +  rect.centerX());
//                Log.d("GOZDEN KACMIS", "mObjThresh: " +  rect.centerY());
//                Log.d("GOZDEN KACMIS", "mObjThresh: " +  rect.height());
//                Log.d("GOZDEN KACMIS", "mObjThresh: " +  rect.width());
                detections.add(new Recognition("" + offset, labels.get(detectedClass),
                        confidenceInClass, rect, detectedClass));
                Log.d("other classification", "bu yolov5 classifier detect other classification");
