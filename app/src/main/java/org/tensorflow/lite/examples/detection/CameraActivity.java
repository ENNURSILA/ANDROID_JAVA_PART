    ...
    postInferenceCallback =
            new Runnable() {
              ...
              public void run() {
                camera.addCallbackBuffer(bytes);
                isProcessingFrame = false;
                // Artık processImage() metodunu çağırmak istemiyoruz.
                postInferenceCallback = null; // Callback'ı null yaparak bir daha çalışmasını engelliyoruz.
              }
            };
...
//  }
  ...
  protected abstract void updateActiveModel() throws IOException;
  int x=1;
