 ...
 */
public class YoloV5ClassifierDetectNEW implements ClassifierThree {
     ...
     */
    public static YoloV5ClassifierDetectyeni create(
            ...
            final int[] anchors*/)
            throws IOException {
        final YoloV5ClassifierDetectyeni d = new YoloV5ClassifierDetectyeni();
...
//    @Override
//    public List<Recognition> recognizeImage2(Bitmap bitmap) {
//        return null;
//    }
...
//    private int[] ANCHORS;
    ...
    private YoloV5ClassifierDetectNEW() {
    }
...
//        float[][][] outbuf = new float[1][output_box][labels.size() + 5];
        ...
        for (int i = 0; i < output_box; ++i){
            ...
            if (confidenceInClass > getObjThresh()) {
                ...
                Log.d("other classification", "bu en sonother classification");
