 ...
 */
public class NEW implements ClassifierThree {
...
//        if (tfLite != null) tfLite.setUseNNAPI(isChecked);
    ...
    public float getObjThresh() {
        return MainActivity.MINIMUM_CONFIDENCE_TF_OD_APIAY;
    }
...
//        float[][][] outbuf = new float[1][output_box][labels.size() + 5];
        ...
        Log.d("yeni", "mObjThresh: " + getObjThresh());

        Object[] inputArray = {imgData};
        tfLite.runForMultipleInputsOutputs(inputArray, outputMap);
//cunku iceceği bir yere gondermiyorsun ve su ayran ayrımını da yap
        ...
        for (int i = 0; i < output_box; ++i){
            ...
            if (confidenceInClass > getObjThresh()) {
                ...
                detections.add(new Recognition("" + offset, labels.get(detectedClass),
                        ...
                        confidenceInClass, rect, detectedClass));//burada
                Log.d(" other classification", "bu yeni classification");


//                if(detectedClass==0){
//                    Log.d("CHECK", "result2: corba");//turuncu corba beyaz corba
//                    final String resultLabell = detector5.recognizeImageturcorba(bitmap);
//
//               }
