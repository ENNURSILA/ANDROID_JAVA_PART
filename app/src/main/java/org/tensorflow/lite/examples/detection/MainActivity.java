...
public class MainActivity extends AppCompatActivity {
    ...
    public static final float MINIMUM_CONFIDENCE_TF_OD_API = 0.9f;

    public static final float MINIMUM_CONFIDENCE_TF_OD_APIAY = 0.3f;
    ...
    private static final String TF_OD_API_MODEL_FILE = "EveningMorning.tflite";
